...
\hypertarget{index}{}\label{index}\index{FreeRTOS C++ Wrappers Documentation@{FreeRTOS C++ Wrappers Documentation}}
 Free\+RTOS C++ Wrappers Modern C++17 RAII wrappers for Free\+RTOS APIs --- lightweight, type-\/safe, and production-\/ready. 

 439Tests Passing 97\%Line Coverage C++17Standard 8Modules \hypertarget{index_intro_sec}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{index_intro_sec}
